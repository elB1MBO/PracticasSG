...
class TheScene extends THREE.Scene {
  ...
  createGUI () {
    ...
    this.GUIcontrols = {
      ...
      height   : 10,
      addBox   : () => {
        this.setMessage ("Añadir cajas clicando en el suelo");
        this.applicationMode = TheScene.ADDING_BOXES;
      },
      moveBox  : () => {
        this.setMessage ("Mover y rotar cajas clicando en ellas");
        this.applicationMode = TheScene.MOVING_BOXES;
      },
      takeBox  : false
    }
    ...
    var actions = gui.addFolder ('Actions');
      ...
      takingBoxes.onChange ( (value) => {
          if (value) {
            var newHeight = this.takeBox();
            if (newHeight > 0) {
                this.GUIcontrols.height = newHeight;
                this.GUIcontrols.takeBox = true; 
            } else {
                this.GUIcontrols.takeBox = false;  
            }
          } else {
            this.dropBox ();
          }
